...
public class Claim {
    ...
    public Claim(int clamId, String clamSource, String clamType, Date clamDate,
                 double clamAmountRequested, int clamIplcId, double clamProcessedAmount,
                 Date clamProcessedDate, int clamProcessedBy, String clamRemarks, String clamStatus) {
        this.clamId = clamId;
    ...
    public String toString() {
        return "Claim{" +
               "clamId=" + clamId +
               ", clamSource='" + clamSource + '\'' +
               ", clamType='" + clamType + '\'' +
               ", clamDate=" + clamDate +
               ", clamAmountRequested=" + clamAmountRequested +
               ", clamIplcId=" + clamIplcId +
               ", clamProcessedAmount=" + clamProcessedAmount +
               ", clamProcessedDate=" + clamProcessedDate +
               ", clamProcessedBy=" + clamProcessedBy +
               ", clamRemarks='" + clamRemarks + '\'' +
